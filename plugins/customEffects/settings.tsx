...
import { Stack, TableRow, TableRowGroup } from "@vendetta/metro/common/components";
...
export default function CustomEffectSettings() {
    ...
    const handleRemoveEffect = React.useCallback(async () => {
        ...
        try {
            ...
            setSelectedEffect(null);
            showToast("Effect removed", getAssetIDByName ("CheckIcon"));
        } catch (e) {
            console.error("Failed to remove effect", e);
            showToast("Failed to remove effect", getAssetIDByName ("CircleXIcon"));
        }
    ...
    const handleLogout = React.useCallback(async () => {
        try {
            ...
            showToast("Logged out", getAssetIDByName ("CheckIcon"));
        }
    }, [authStore]);
                    ...
                    <>
                        <TableRowGroup title="Effects">
                            <TableRow
                                ...
                                icon={<TableRow.Icon source={getAssetIDByName ("TrashIcon")} />}
                            ...
                            {hasEffects && (
                                <TableRow
                                    ...
                                    icon={<TableRow.Icon source={getAssetIDByName ("ic_reaction_smile")} />}
                        ...
                        <TableRowGroup title="Account">
                            <TableRow
                                ...
                                icon={<TableRow.Icon variant="danger" source={getAssetIDByName ("DoorExitIcon")} />}
